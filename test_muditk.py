...
def f06(string1, string2):
    ...
    if len(string1) > len(string2):
        print("'string1' is longer than 'string2' by {} chars".format(len(string1) - len(string2)))
       # print("'string 2' has only {} the number of chars of 'string1'".format(((len(string1) - len(string2)/len(string1)*100))
    elif len(string2) > len(string1):
        print("'string2' is longer than 'string1' by {} chars".format(len(string2) - len(string1)))
